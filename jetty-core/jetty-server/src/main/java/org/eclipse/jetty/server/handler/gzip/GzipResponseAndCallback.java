...
public class GzipResponseAndCallback extends Response.Wrapper implements Callback, Invocable
{
    ...
    private class GzipBufferCB extends IteratingNestedCallback
    {
         ...
         */
        private Action compressing(Deflater deflater, WritableBuffer outputBuffer)
        {
            if (LOG.isDebugEnabled())
         ...
         */
        private Action finishing(Deflater deflater, WritableBuffer outputBuffer)
        {
            if (LOG.isDebugEnabled())
        ...
        private void write(boolean last, ReadableBuffer outputBuffer)
        {
            if (LOG.isDebugEnabled())
